...
export class TransactionsApi {
     ...
     */
    public async authorizeTransaction (transactionId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Transaction;  }> {
        const localVarPath = this.basePath + '/transactions/{transaction_id}/authorize'
        ...
        if (transactionId === null || transactionId === undefined) {
            throw new Error('Required parameter transactionId was null or undefined when calling authorizeTransaction.');
        }
     ...
     */
    public async listTransactions (search?: string, transactionStatus?: 'processing' | 'processing_failed' | 'captured' | 'capture_pending' | 'capture_declined' | 'authorized' | 'authorization_pending' | 'authorization_declined' | 'authorization_expired' | 'authorization_voided' | 'refunded' | 'buyer_approval_pending' | 'buyer_approval_declined' | 'buyer_approval_timedout', beforeCreatedAt?: string, afterCreatedAt?: string, beforeUpdatedAt?: string, afterUpdatedAt?: string, limit?: number, cursor?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Transactions;  }> {
        const localVarPath = this.basePath + '/transactions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (transactionStatus !== undefined) {
            localVarQueryParameters['transaction_status'] = ObjectSerializer.serialize(transactionStatus, "'processing' | 'processing_failed' | 'captured' | 'capture_pending' | 'capture_declined' | 'authorized' | 'authorization_pending' | 'authorization_declined' | 'authorization_expired' | 'authorization_voided' | 'refunded' | 'buyer_approval_pending' | 'buyer_approval_declined' | 'buyer_approval_timedout'");
        }
     ...
     * @param transactionId The ID for the transaction to get the information for.
     */
    public async refundTransaction (transactionId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Transaction;  }> {
