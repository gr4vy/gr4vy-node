...
export class PaymentServicesApi {
     ...
     */
    public async listPaymentServices (limit?: number, cursor?: string, method?: 'afterpay' | 'applepay' | 'banked' | 'boleto' | 'card' | 'clearpay' | 'dana' | 'fortumo' | 'gcash' | 'gocardless' | 'googlepay' | 'googlepay_pan_only' | 'grabpay' | 'klarna' | 'ovo' | 'paymaya' | 'paypal' | 'pix' | 'rabbitlinepay' | 'shopeepay' | 'stripedd' | 'truemoney' | 'trustly' | 'zippay', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaymentServices;  }> {
        const localVarPath = this.basePath + '/payment-services';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (method !== undefined) {
            localVarQueryParameters['method'] = ObjectSerializer.serialize(method, "'afterpay' | 'applepay' | 'banked' | 'boleto' | 'card' | 'clearpay' | 'dana' | 'fortumo' | 'gcash' | 'gocardless' | 'googlepay' | 'googlepay_pan_only' | 'grabpay' | 'klarna' | 'ovo' | 'paymaya' | 'paypal' | 'pix' | 'rabbitlinepay' | 'shopeepay' | 'stripedd' | 'truemoney' | 'trustly' | 'zippay'");
        }
