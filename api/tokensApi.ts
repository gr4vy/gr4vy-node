...
export class TokensApi {
     ...
     */
    public async approvePaymentServiceTokenGet (paymentMethodId: string, paymentServiceTokenId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/payment-methods/{payment_method_id}/payment-service-tokens/{payment_service_token_id}/approve'
        ...
        if (paymentMethodId === null || paymentMethodId === undefined) {
            throw new Error('Required parameter paymentMethodId was null or undefined when calling approvePaymentServiceTokenGet.');
        }
        ...
        if (paymentServiceTokenId === null || paymentServiceTokenId === undefined) {
            throw new Error('Required parameter paymentServiceTokenId was null or undefined when calling approvePaymentServiceTokenGet.');
        }
     ...
     * @param paymentServiceTokenId The ID of the payment service token.
     */
    public async approvePaymentServiceTokenPost (paymentMethodId: string, paymentServiceTokenId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/payment-methods/{payment_method_id}/payment-service-tokens/{payment_service_token_id}/approve'
            .replace('{' + 'payment_method_id' + '}', encodeURIComponent(String(paymentMethodId)))
            .replace('{' + 'payment_service_token_id' + '}', encodeURIComponent(String(paymentServiceTokenId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'paymentMethodId' is not null or undefined
        if (paymentMethodId === null || paymentMethodId === undefined) {
            throw new Error('Required parameter paymentMethodId was null or undefined when calling approvePaymentServiceTokenPost.');
        }

        // verify required parameter 'paymentServiceTokenId' is not null or undefined
        if (paymentServiceTokenId === null || paymentServiceTokenId === undefined) {
            throw new Error('Required parameter paymentServiceTokenId was null or undefined when calling approvePaymentServiceTokenPost.');
        }
