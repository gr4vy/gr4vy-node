...
export class VaultForwardApi {
     ...
     * @param xVaultForwardHeaderHEADERNAME A header that is forwarded to the &#x60;x-vault-forward-url&#x60;. The header will be forwarded without the &#x60;x-vault-forward-header&#x60; part. For example, &#x60;x-vault-forward-header-content-type: application/json&#x60; is forwarded as &#x60;content-type: application/json&#x60;.
