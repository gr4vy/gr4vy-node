...
describe('.verifyWebook()', () => {
  test('it should verify webhook happy case', async () => {
    const secret =
  ...
  test('it should raise an error for an old timestamp', async () => {
    const secret =
      'Ik4L-8FH0ihWczctcIPXZRR_8F0fPNgmhEfVBbZ3zNwqQVa1Or4tBz4Pgw2eNaVDod7H56Y268h_wohEUaWbUg'
    const signatureHeader =
      '78aca0c78005107a654a957b8566fa6e0e5e06aea92d7da72a6da9e5a690d013,other'
  ...
  test('it should raise an error for a wrong signature', async () => {
    const secret =
      'Ik4L-8FH0ihWczctcIPXZRR_8F0fPNgmhEfVBbZ3zNwqQVa1Or4tBz4Pgw2eNaVDod7H56Y268h_wohEUaWbUg'
  ...
  test('it should raise an error for an invalid timestamp', async () => {
    const secret =
      'Ik4L-8FH0ihWczctcIPXZRR_8F0fPNgmhEfVBbZ3zNwqQVa1Or4tBz4Pgw2eNaVDod7H56Y268h_wohEUaWbUg'
    const signatureHeader =
      '78aca0c78005107a654a957b8566fa6e0e5e06aea92d7da72a6da9e5a690d013,other'
  ...
  test('it should raise an error for a missing signature header', async () => {
    const secret =
      'Ik4L-8FH0ihWczctcIPXZRR_8F0fPNgmhEfVBbZ3zNwqQVa1Or4tBz4Pgw2eNaVDod7H56Y268h_wohEUaWbUg'
  ...
  test('it should raise an error for a missing timestamp header', async () => {
    const secret =
      'Ik4L-8FH0ihWczctcIPXZRR_8F0fPNgmhEfVBbZ3zNwqQVa1Or4tBz4Pgw2eNaVDod7H56Y268h_wohEUaWbUg'
    const signatureHeader =
      '78aca0c78005107a654a957b8566fa6e0e5e06aea92d7da72a6da9e5a690d013,other'
