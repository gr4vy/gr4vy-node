...
*/
export class AntiFraudDecisionEvent {
    /**
    * The type of this resource. Is always `transaction-event`.
    */
    'type'?: AntiFraudDecisionEvent.TypeEnum;
    /**
    ...
    */
    'name'?: AntiFraudDecisionEvent.NameEnum;
    /**
    * The date and time when this transaction was created in our system.
    */
    'createdAt'?: Date;
    'context'?: AntiFraudDecisionEventContext;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "name",
            "baseName": "name",
            "type": "AntiFraudDecisionEvent.NameEnum"
        },
        {
            "name": "createdAt",
            "baseName": "created_at",
        ...
        },
        {
            "name": "context",
            "baseName": "context",
            "type": "AntiFraudDecisionEventContext"
        }    ];

    static getAttributeTypeMap() {
        return AntiFraudDecisionEvent.attributeTypeMap;
    }
}
