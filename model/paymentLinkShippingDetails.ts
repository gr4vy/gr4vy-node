...
*/
export class PaymentLinkShippingDetails {
    /**
    * The type of this resource. Is always `shipping-details`.
    */
    'type'?: PaymentLinkShippingDetails.TypeEnum;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return PaymentLinkShippingDetails.attributeTypeMap;
    }
}

export namespace PaymentLinkShippingDetails {
