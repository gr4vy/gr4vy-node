...
*/
export class PaymentConnectorResponseTransactionCaptureDeclinedEvent {
    /**
    * The type of this resource. Is always `transaction-event`.
    */
    'type'?: PaymentConnectorResponseTransactionCaptureDeclinedEvent.TypeEnum;
    /**
    ...
    */
    'name'?: PaymentConnectorResponseTransactionCaptureDeclinedEvent.NameEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "name",
            "baseName": "name",
            "type": "PaymentConnectorResponseTransactionCaptureDeclinedEvent.NameEnum"
        },
        {
            "name": "createdAt",
            "baseName": "created_at",
    ...
    static getAttributeTypeMap() {
        return PaymentConnectorResponseTransactionCaptureDeclinedEvent.attributeTypeMap;
    }
}
