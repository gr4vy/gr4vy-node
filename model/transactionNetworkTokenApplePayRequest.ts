...
*/
export class TransactionNetworkTokenApplePayRequest {
    /**
    * `network-token`.
    */
    'method': TransactionNetworkTokenApplePayRequest.MethodEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "method",
            "baseName": "method",
            "type": "TransactionNetworkTokenApplePayRequest.MethodEnum"
        },
        {
            "name": "token",
            "baseName": "token",
        ...
        },
        {
            ...
            "type": "TransactionNetworkTokenApplePayRequest.CardSourceEnum"
        },
        {
            "name": "cardSuffix",
    ...
    static getAttributeTypeMap() {
        return TransactionNetworkTokenApplePayRequest.attributeTypeMap;
    }
}

export namespace TransactionNetworkTokenApplePayRequest {
