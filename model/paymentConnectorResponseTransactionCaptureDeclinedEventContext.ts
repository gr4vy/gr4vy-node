...
*/
export class PaymentConnectorResponseTransactionCaptureDeclinedEventContext {
    /**
    ...
    */
    'avsResponseCode'?: PaymentConnectorResponseTransactionCaptureDeclinedEventContext.AvsResponseCodeEnum;
    /**
    ...
    */
    'cvvResponseCode'?: PaymentConnectorResponseTransactionCaptureDeclinedEventContext.CvvResponseCodeEnum;
    /**
    * The card scheme sent to the connector.
    */
    'paymentMethodScheme'?: PaymentConnectorResponseTransactionCaptureDeclinedEventContext.PaymentMethodSchemeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "PaymentConnectorResponseTransactionCaptureDeclinedEventContext.AvsResponseCodeEnum"
        },
        {
            "name": "cvvResponseCode",
            "baseName": "cvv_response_code",
            "type": "PaymentConnectorResponseTransactionCaptureDeclinedEventContext.CvvResponseCodeEnum"
        },
        {
            "name": "paymentMethodScheme",
            "baseName": "payment_method_scheme",
            "type": "PaymentConnectorResponseTransactionCaptureDeclinedEventContext.PaymentMethodSchemeEnum"
        }    ];

    static getAttributeTypeMap() {
        return PaymentConnectorResponseTransactionCaptureDeclinedEventContext.attributeTypeMap;
    }
}
