...
*/
export class PaymentConnectorResponseTransactionAuthorizationSucceededEventContext {
    /**
    ...
    */
    'status'?: PaymentConnectorResponseTransactionAuthorizationSucceededEventContext.StatusEnum;
    /**
    * The type of instrument used for this transaction.
    */
    'instrumentType'?: PaymentConnectorResponseTransactionAuthorizationSucceededEventContext.InstrumentTypeEnum;
    /**
    ...
    */
    'cvvResponseCode'?: PaymentConnectorResponseTransactionAuthorizationSucceededEventContext.CvvResponseCodeEnum;
    /**
    * The card scheme sent to the connector.
    */
    'paymentMethodScheme'?: PaymentConnectorResponseTransactionAuthorizationSucceededEventContext.PaymentMethodSchemeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "PaymentConnectorResponseTransactionAuthorizationSucceededEventContext.StatusEnum"
        },
        {
            "name": "instrumentType",
            "baseName": "instrument_type",
            "type": "PaymentConnectorResponseTransactionAuthorizationSucceededEventContext.InstrumentTypeEnum"
        },
        {
            "name": "retryRule",
            "baseName": "retry_rule",
        ...
        },
        {
            ...
            "type": "PaymentConnectorResponseTransactionAuthorizationSucceededEventContext.AvsResponseCodeEnum"
        },
        {
            "name": "cvvResponseCode",
            "baseName": "cvv_response_code",
            "type": "PaymentConnectorResponseTransactionAuthorizationSucceededEventContext.CvvResponseCodeEnum"
        },
        {
            "name": "paymentMethodScheme",
            "baseName": "payment_method_scheme",
            "type": "PaymentConnectorResponseTransactionAuthorizationSucceededEventContext.PaymentMethodSchemeEnum"
        }    ];

    static getAttributeTypeMap() {
        return PaymentConnectorResponseTransactionAuthorizationSucceededEventContext.attributeTypeMap;
    }
}
