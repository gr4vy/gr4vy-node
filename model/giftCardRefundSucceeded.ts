...
*/
export class GiftCardRefundSucceeded {
    /**
    * The type of this resource. Is always `transaction-event`.
    */
    'type'?: GiftCardRefundSucceeded.TypeEnum;
    /**
    ...
    */
    'name'?: GiftCardRefundSucceeded.NameEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "name",
            "baseName": "name",
            "type": "GiftCardRefundSucceeded.NameEnum"
        },
        {
            "name": "createdAt",
            "baseName": "created_at",
    ...
    static getAttributeTypeMap() {
        return GiftCardRefundSucceeded.attributeTypeMap;
    }
}
