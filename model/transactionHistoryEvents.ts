...
export class TransactionHistoryEvents {
    ...
    */
    'items'?: Array<AntiFraudDecisionTransactionEvent | ThreeDSecureSuccessTransactionEvent>;
    /**
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<AntiFraudDecisionTransactionEvent | ThreeDSecureSuccessTransactionEvent>"
        },
        {
            "name": "limit",
            "baseName": "limit",
