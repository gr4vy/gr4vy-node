...
*/
export class ConnectionOptionsForterAntiFraudDeliveryDetails {
    /**
    ...
    */
    'deliveryType'?: ConnectionOptionsForterAntiFraudDeliveryDetails.DeliveryTypeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "ConnectionOptionsForterAntiFraudDeliveryDetails.DeliveryTypeEnum"
        },
        {
            "name": "deliveryMethod",
    ...
    static getAttributeTypeMap() {
        return ConnectionOptionsForterAntiFraudDeliveryDetails.attributeTypeMap;
    }
}

export namespace ConnectionOptionsForterAntiFraudDeliveryDetails {
