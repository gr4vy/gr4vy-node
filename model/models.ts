...
let enumsMap: { [index: string]: any } = {
  ...
  'PaymentServiceDefinitionFields.FormatEnum':
    PaymentServiceDefinitionFields.FormatEnum,
  'PaymentServiceRequest.CredentialsModeEnum':
    PaymentServiceRequest.CredentialsModeEnum,
  'PaymentServiceRequest.EnvironmentsEnum':
    PaymentServiceRequest.EnvironmentsEnum,
  ...
  'PaymentServiceUpdate.CredentialsModeEnum':
    PaymentServiceUpdate.CredentialsModeEnum,
  'PaymentServiceUpdate.EnvironmentsEnum':
    PaymentServiceUpdate.EnvironmentsEnum,
